...
export type Formula = {
    ...
    readonly kind: "add" | "multiply" | "minimum" | "maximum";
    ...
    readonly kind: "negate" | "absolute" | "floor" | "ceil" | "round" | "fibonacci";
    readonly operand: Formula;
};
export type FormulaTarget = {
    readonly kind: "attribute";
    readonly attributeId: EntityId;
    readonly value: "base" | "improvement" | "effective";
} | {
    readonly kind: "skill";
    ...
    readonly value: "current" | "minimum" | "maximum";
} | {
    readonly kind: "variable";
    readonly name: "level" | "difficulty";
};
